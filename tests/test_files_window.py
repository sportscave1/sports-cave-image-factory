...
class FilesWindowInteractionContractTests(unittest.TestCase):
    ...
    def test_folder_listing_cache_deduplicates_requests_and_keeps_stale_navigation_guard(self):
        ...
        self.assertIn("elements.loadingIndicator.hidden", self.client)
        self.assertNotIn('elements.itemCount.textContent = "Opening folder..."', self.client)
        self.assertNotIn('Loading more...', self.client)
