...
class RouteReliabilityTests(unittest.TestCase):
    ...
    def test_top_bar_navigation_feedback_and_lifecycle_are_idempotent(self):
        ...
        self.assertIn('body.sc-navigation-pending #${LOADER_ID} { display: flex; }', source)
        self.assertIn('class="sc-loading-spinner"', source)
        self.assertNotIn('body.sc-navigation-pending #${ROOT_ID}::after', source)
