...
class EditionOpsUiTests(unittest.TestCase):
    ...
    def test_orders_file_action_reuses_named_files_window_without_dropbox_listing(self):
        ...
        self.assertIn('displayLabel = "Open"', handler)
    ...
    def test_render_primary_is_externally_managed_and_webhook_service_is_separate(self):
        ...
        self.assertIn("sports-cave-os (srv-d8kl4on7f7vs73dvavv0)", source)
        self.assertNotIn("startCommand: python sports_cave_server.py", source)
    ...
    def test_orders_page_is_snapshot_based_and_lightweight(self):
        ...
        self.assertIn('"PSD"', inspect.getsource(orders_page._column_config))
        self.assertIn('display_text="PSD"', inspect.getsource(orders_page._column_config))
...
class OrdersDatabaseReadRepairTests(unittest.TestCase):
    ...
    def test_orders_page_does_not_show_marketplace_schema_warning_to_core_users(self):
        source = inspect.getsource(orders_page._render_orders_data_area)

        self.assertNotIn('read_diagnostic.get("compatibility_mode")', source)
        self.assertNotIn("20260818_shopify_marketplace_order_reconciliation.sql", source)
        self.assertNotIn("temporarily using the previous database schema", source)
